...
Idx Name          Size      VMA               LMA               File off  Algn
 ...
 12 .plt.got      00000010  0000000000001030  0000000000001030  00001030  2**4
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 13 .text         0000012b  0000000000001040  0000000000001040  00001040  2**4
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 14 .fini         0000000d  000000000000116c  000000000000116c  0000116c  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 15 .rodata       00000010  0000000000002000  0000000000002000  00002000  2**3
                  CONTENTS, ALLOC, LOAD, READONLY, DATA
 16 .eh_frame_hdr 00000034  0000000000002010  0000000000002010  00002010  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, DATA
 17 .eh_frame     0000009c  0000000000002048  0000000000002048  00002048  2**3
                  CONTENTS, ALLOC, LOAD, READONLY, DATA
...
0000000000000000 l    df *ABS*	0000000000000000              crtstuff.c
00000000000020e0 l     O .eh_frame	0000000000000000              __FRAME_END__
...
000000000000116c g     F .fini	0000000000000000              .hidden _fini
0000000000004000 g       .data	0000000000000000              __data_start
0000000000000000  w      *UND*	0000000000000000              __gmon_start__
0000000000004008 g     O .data	0000000000000000              .hidden __dso_handle
0000000000002000 g     O .rodata	0000000000000004              _IO_stdin_used
0000000000001129 g     F .text	0000000000000022              f1
0000000000004018 g       .bss	0000000000000000              _end
0000000000001040 g     F .text	0000000000000026              _start
0000000000004010 g       .bss	0000000000000000              __bss_start
000000000000114b g     F .text	0000000000000020              main
...
0000000000001040 <_start>:
    ...
    1058:	48 8d 3d ec 00 00 00 	lea    0xec(%rip),%rdi        # 114b <main>
...
0000000000001129 <f1>:
    ...
    112d:	66 0f 28 c8          	movapd %xmm0,%xmm1
    1131:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1135:	f2 0f 2a c7          	cvtsi2sd %edi,%xmm0
    1139:	f2 0f 58 c8          	addsd  %xmm0,%xmm1
    113d:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1141:	f2 48 0f 2a c6       	cvtsi2sd %rsi,%xmm0
    1146:	f2 0f 58 c1          	addsd  %xmm1,%xmm0
    114a:	c3                   	ret    

000000000000114b <main>:
    114b:	f3 0f 1e fa          	endbr64 
    114f:	be 04 00 00 00       	mov    $0x4,%esi
    1154:	f2 0f 10 05 ac 0e 00 	movsd  0xeac(%rip),%xmm0        # 2008 <_IO_stdin_used+0x8>
    115b:	00 
    115c:	bf 02 00 00 00       	mov    $0x2,%edi
    1161:	e8 c3 ff ff ff       	call   1129 <f1>
    1166:	f2 0f 2c c0          	cvttsd2si %xmm0,%eax
    116a:	c3                   	ret    

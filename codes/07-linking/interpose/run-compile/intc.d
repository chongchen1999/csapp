...
Idx Name          Size      VMA               LMA               File off  Algn
 ...
 14 .plt.sec      00000030  0000000000001070  0000000000001070  00001070  2**4
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 15 .text         0000016f  00000000000010a0  00000000000010a0  000010a0  2**4
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 16 .fini         0000000d  0000000000001210  0000000000001210  00001210  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
...
0000000000001210 g     F .fini	0000000000000000              .hidden _fini
...
00000000000011ad g     F .text	000000000000003a              mymalloc
0000000000004010 g       .bss	0000000000000000              __bss_start
0000000000001189 g     F .text	0000000000000024              main
...
00000000000011e7 g     F .text	0000000000000028              myfree
...
0000000000000368 <.note.gnu.build-id>:
 ...
 377:	00 64 d3 19          	add    %ah,0x19(%rbx,%rdx,8)
 37b:	15 5b d8 32 d8       	adc    $0xd832d85b,%eax
 380:	34 38                	xor    $0x38,%al
 382:	d4                   	(bad)  
 383:	54                   	push   %rsp
 384:	ad                   	lods   %ds:(%rsi),%eax
 385:	b0 35                	mov    $0x35,%al
 387:	94                   	xchg   %eax,%esp
 388:	90                   	nop
 389:	b6 d6                	mov    $0xd6,%dh
 38b:	8c                   	.byte 0x8c
...
0000000000001189 <main>:
    ...
    1191:	bf 20 00 00 00       	mov    $0x20,%edi
    1196:	e8 12 00 00 00       	call   11ad <mymalloc>
    119b:	48 89 c7             	mov    %rax,%rdi
    119e:	e8 44 00 00 00       	call   11e7 <myfree>
    11a3:	b8 00 00 00 00       	mov    $0x0,%eax
    11a8:	48 83 c4 08          	add    $0x8,%rsp
    11ac:	c3                   	ret    

00000000000011ad <mymalloc>:
    11ad:	f3 0f 1e fa          	endbr64 
    11b1:	55                   	push   %rbp
    11b2:	53                   	push   %rbx
    11b3:	48 83 ec 08          	sub    $0x8,%rsp
    11b7:	48 89 fb             	mov    %rdi,%rbx
    11ba:	e8 c1 fe ff ff       	call   1080 <malloc@plt>
    11bf:	48 89 c5             	mov    %rax,%rbp
    11c2:	89 da                	mov    %ebx,%edx
    11c4:	48 89 c1             	mov    %rax,%rcx
    ...
    11d8:	e8 b3 fe ff ff       	call   1090 <__printf_chk@plt>
    11dd:	48 89 e8             	mov    %rbp,%rax
    11e0:	48 83 c4 08          	add    $0x8,%rsp
    11e4:	5b                   	pop    %rbx
    11e5:	5d                   	pop    %rbp
    11e6:	c3                   	ret    

00000000000011e7 <myfree>:
    11e7:	f3 0f 1e fa          	endbr64 
    11eb:	53                   	push   %rbx
    11ec:	48 89 fb             	mov    %rdi,%rbx
    11ef:	e8 7c fe ff ff       	call   1070 <free@plt>
    11f4:	48 89 da             	mov    %rbx,%rdx
    ...
    1208:	e8 83 fe ff ff       	call   1090 <__printf_chk@plt>
    120d:	5b                   	pop    %rbx
    120e:	c3                   	ret    
...
0000000000002020 <__GNU_EH_FRAME_HDR>:
    ...
    2056:	ff                   	(bad)  
    2057:	ff                   	(bad)  
    2058:	e8 00 00 00 c7       	call   ffffffffc700205d <_end+0xffffffffc6ffe045>
    205d:	f1                   	int1   
    205e:	ff                   	(bad)  
    205f:	ff 10                	call   *(%rax)
...
0000000000002068 <__FRAME_END__-0xe4>:
    ...
    20f9:	f0 ff                	lock (bad) 
    20fb:	ff 24 00             	jmp    *(%rax,%rax,1)
    20fe:	00 00                	add    %al,(%rax)
    2100:	00 48 0e             	add    %cl,0xe(%rax)
    2103:	10 5b 0e             	adc    %bl,0xe(%rbx)
    2106:	08 00                	or     %al,(%rax)
    2108:	24 00                	and    $0x0,%al
    210a:	00 00                	add    %al,(%rax)
    210c:	a4                   	movsb  %ds:(%rsi),%es:(%rdi)
    210d:	00 00                	add    %al,(%rax)
    210f:	00 9d f0 ff ff 3a    	add    %bl,0x3afffff0(%rbp)
    ...
    2137:	00 af f0 ff ff 28    	add    %ch,0x28fffff0(%rdi)

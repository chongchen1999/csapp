...
Program Header:
  ...
  INTERP off    0x0000000000000318 vaddr 0x0000000000000318 paddr 0x0000000000000318 align 2**0
    ...
    LOAD off    0x0000000000002000 vaddr 0x0000000000002000 paddr 0x0000000000002000 align 2**12
         filesz 0x0000000000000128 memsz 0x0000000000000128 flags r--
...
Idx Name          Size      VMA               LMA               File off  Algn
 ...
 14 .plt.sec      00000020  0000000000001060  0000000000001060  00001060  2**4
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 15 .text         0000018d  0000000000001080  0000000000001080  00001080  2**4
                  CONTENTS, ALLOC, LOAD, READONLY, CODE
 ...
 18 .eh_frame_hdr 00000044  0000000000002008  0000000000002008  00002008  2**2
                  CONTENTS, ALLOC, LOAD, READONLY, DATA
 19 .eh_frame     000000d8  0000000000002050  0000000000002050  00002050  2**3
                  CONTENTS, ALLOC, LOAD, READONLY, DATA
...
0000000000000000 l    df *ABS*	0000000000000000              crtstuff.c
0000000000002124 l     O .eh_frame	0000000000000000              __FRAME_END__
...
0000000000001169 g     F .text	0000000000000008              _Z3addii
...
000000000000117a g     F .text	0000000000000093              main
...
0000000000001171 g     F .text	0000000000000009              _Z4add2RKiS0_
...
0000000000001080 <_start>:
    ...
    1098:	48 8d 3d db 00 00 00 	lea    0xdb(%rip),%rdi        # 117a <main>
...
0000000000001169 <_Z3addii>:
    ...
    116d:	8d 04 37             	lea    (%rdi,%rsi,1),%eax
    1170:	c3                   	ret    

0000000000001171 <_Z4add2RKiS0_>:
    1171:	f3 0f 1e fa          	endbr64 
    1175:	8b 06                	mov    (%rsi),%eax
    1177:	03 07                	add    (%rdi),%eax
    1179:	c3                   	ret    
...
000000000000117a <main>:
    ...
    1193:	c7 04 24 0a 00 00 00 	movl   $0xa,(%rsp)
    119a:	c7 44 24 04 14 00 00 	movl   $0x14,0x4(%rsp)
    11a1:	00 
    11a2:	be 14 00 00 00       	mov    $0x14,%esi
    11a7:	bf 0a 00 00 00       	mov    $0xa,%edi
    11ac:	e8 b8 ff ff ff       	call   1169 <_Z3addii>
    11b1:	89 c2                	mov    %eax,%edx
    11b3:	48 8d 1d 4a 0e 00 00 	lea    0xe4a(%rip),%rbx        # 2004 <_IO_stdin_used+0x4>
    11ba:	48 89 de             	mov    %rbx,%rsi
    11bd:	bf 01 00 00 00       	mov    $0x1,%edi
    11c2:	b8 00 00 00 00       	mov    $0x0,%eax
    11c7:	e8 a4 fe ff ff       	call   1070 <__printf_chk@plt>
    11cc:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11d1:	48 89 e7             	mov    %rsp,%rdi
    11d4:	e8 98 ff ff ff       	call   1171 <_Z4add2RKiS0_>
    11d9:	89 c2                	mov    %eax,%edx
    11db:	48 89 de             	mov    %rbx,%rsi
    11de:	bf 01 00 00 00       	mov    $0x1,%edi
    11e3:	b8 00 00 00 00       	mov    $0x0,%eax
    11e8:	e8 83 fe ff ff       	call   1070 <__printf_chk@plt>
    11ed:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11f2:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f9:	00 00 
    11fb:	75 0b                	jne    1208 <main+0x8e>
    11fd:	b8 00 00 00 00       	mov    $0x0,%eax
    1202:	48 83 c4 10          	add    $0x10,%rsp
    1206:	5b                   	pop    %rbx
    1207:	c3                   	ret    
    1208:	e8 53 fe ff ff       	call   1060 <__stack_chk_fail@plt>
